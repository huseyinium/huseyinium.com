...
interface HeroVideoProps {
  ...
  thumbnailAlt?: string
  className?: string
  /** Fill the parent container instead of sizing from the thumbnail's intrinsic ratio */
  fill?: boolean
}
  ...
  return (
    <div className={cn('relative', fill && 'size-full', className)}>
      <button
        ...
        className={cn(
          'group relative cursor-pointer border-0 bg-transparent p-0',
      ...
      >
        <img
          ...
          className={cn(
            ...
            fill && 'size-full rounded-none border-0 object-cover'
          )}
        />
